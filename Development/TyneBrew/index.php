...
<div class="navbar">
    ...
    <div class="image-container">
        ...
        <div class="image-title">
            ...
            <br>
            <h2>Tyne Brew Coffee: The Art of Blending Perfection,Where Every Bean is <br>Carefully Selected and
                Expertly
                Crafted to Deliver <br> a Flavor Experience Like No Other</h2>
            <br>
            <br>
            <button class="button button1">
  <a href="loginn.php" style="color: white; text-decoration: none;">LOGIN NOW</a>
</button>
    ...
    <div class="grid-container">
        ...
        <div class="main1">
            <img src="Images/Main.jpg" alt="Coffee Image" height="auto" width="auto">
        </div>
        <div class="main2">
            <div class="aboutus">
                <br><br>
                <h1>What Makes our Coffee Special?</h1><br><br>
